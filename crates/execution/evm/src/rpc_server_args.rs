...
use reth_node_core::args::GasPriceOracleArgs;

/// The default IPC endpoint
#[cfg(windows)]
pub const DEFAULT_IPC_ENDPOINT: &str = r"\\.\pipe\rayls.ipc";

/// The default IPC endpoint
#[cfg(not(windows))]
pub const DEFAULT_IPC_ENDPOINT: &str = "/tmp/rayls.ipc";
...
impl Default for RpcServerArgs {
    fn default() -> Self {
        Self {
            ...
            gpo: GasPriceOracleArgs::default(),
        }
    }
}
