...
use rayls_consensus_primary::test_utils::mock_certificate_with_rand;
...
impl ExecutionPlan {
    fn hash(&self) -> [u8; rayls_infrastructure_types::DIGEST_LENGTH] {
        let mut hasher = rayls_infrastructure_types::DefaultHashFunction::new();
